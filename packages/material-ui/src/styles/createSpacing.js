        ...
        if (!warnOnce || process.env.NODE_ENV === 'test') {
          console.error(
            [
              ...
              '',
              'You can use the `https://github.com/Foso/material-ui/tree/master/packages/material-ui-codemod/README.md#theme-spacing-api` migration helper to make the process smoother.',
            ].join('\n'),
          );
        }
