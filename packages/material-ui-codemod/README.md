...
Updates the `svg-icons` import paths from `material-ui/svg-icons/<category>/<icon-name>` to `@material-ui/icons/<IconName>`, to use the new [`@material-ui/icons`](https://github.com/Foso/material-ui/tree/master/packages/material-ui-icons) package.
The diff should look like this:
